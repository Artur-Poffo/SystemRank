  ...
  return (
    <section id="#about" className="flex flex-col items-center mb-24 px-4" >
      ...
      >
        ...
        <p>Graças a SystemRank podemos encontrar informações dos mais diversos tipo de sistemas operacionais, toda a informação e divulgação que você precisa em um só lugar.</p>
      </motion.div>
    </section>
  )
}